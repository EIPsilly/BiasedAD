...
# FMNIST446 不同比例采样
python main.py --model_type BiasedADM --dir_path ./kdd_results/BADM_20240202/fmnist_sample --dataset_name fashionmnist --normal_class 4 --non_target_outlier_class 4 --target_outlier_class 6 --gpu 2 --random_seed 0 --s_normal 1.0 --labeled_target_outlier_number 100&
python main.py --model_type BiasedADM --dir_path ./kdd_results/BADM_20240202/fmnist_sample --dataset_name fashionmnist --normal_class 4 --non_target_outlier_class 4 --target_outlier_class 6 --gpu 2 --random_seed 0 --s_normal 0.5 --labeled_target_outlier_number 50&
python main.py --model_type BiasedADM --dir_path ./kdd_results/BADM_20240202/fmnist_sample --dataset_name fashionmnist --normal_class 4 --non_target_outlier_class 4 --target_outlier_class 6 --gpu 2 --random_seed 0 --s_normal 0.2 --labeled_target_outlier_number 20&
python main.py --model_type BiasedADM --dir_path ./kdd_results/BADM_20240202/fmnist_sample --dataset_name fashionmnist --normal_class 4 --non_target_outlier_class 4 --target_outlier_class 6 --gpu 2 --random_seed 0 --s_normal 0.1 --labeled_target_outlier_number 10&